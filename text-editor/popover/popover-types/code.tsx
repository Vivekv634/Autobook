...
//         className={cn(
//           commonClassNames,
//           "font-mono px-3 py-3 rounded-md bg-muted whitespace-pre-wrap"
//         )}
//         contentEditable={isContentEditable}
//       ></code>
//       {/* <Copy
//         className="absolute top-2 right-2 cursor-pointer text-muted-foreground/80 rounded-md h-6 w-6 p-1 group-focus-within:text-accent-foreground group-hover:text-accent-foreground dark:group-focus-within:text-accent"
//         onClick={() =>
